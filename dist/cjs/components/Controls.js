...
function Controls({ controlsPageNumbers, controlsClassName, buttonClassName, pagesClassName, ellipsisClassName, flip, flipTo, pageWindowStart, isFlipping, pages, }) {
    return (react_1.default.createElement("div", { className: controlsClassName, style: controlsClassName
        ...
        react_1.default.createElement("button", { onClick: () => flip(Flipbook_1.PageDirection.LEFT), disabled: pageWindowStart <= -2 || isFlipping, className: buttonClassName }, !buttonClassName && `<-`),
        controlsPageNumbers && (react_1.default.createElement("div", { className: pagesClassName },
